...
{
    HashMap<Location, Waypoint> open_waypoints = new HashMap<Location, Waypoint>();//открытые точки
    HashMap<Location, Waypoint> closed_waypoints = new HashMap<Location, Waypoint>();//закрытые точки
